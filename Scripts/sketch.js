...
//
//		//const api_url ='https://api.darksky.net/forecast/***/${lat},${lon}';
...
//fetch('https://api.darksky.net/forecast/***/37.8267,-122.4233',{mode: 'no-cors'})
...
//const fetchweather = () => {
//	const api_url = 'https://api.darksky.net/forecast/***/37.8267,-122.4233'
//	.then((data) =>{
//		return data.json();
//		console.log("work?");
//	})
